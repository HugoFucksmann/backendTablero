...
const PuzzleStore = {
     ...
     *
     * @param {object} puzzle  Raw puzzle object from PuzzleExtractor._savePuzzle()
     * @returns {object|null}  The saved entry, or null if it was a duplicate.
     */
    save(puzzle) {
    ...
    /**
     * Deletes all puzzles.
     * @returns {number} Number of puzzles deleted.
     */
    clear() {
