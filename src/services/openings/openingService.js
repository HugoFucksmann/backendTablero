...
/**
 * MAX_BOOK_PLY: Limite de jugadas teóricas a detectar.
 */
const MAX_BOOK_PLY = 30;

/**
 * OpeningService.js (Refactorizado)
 * ────────────────────────────────
 * Responsabilidad: Detectar aperturas usando EXCLUSIVAMENTE los archivos
 * TSV locales. Elimina dependencias de Lichess API y Polyglot (.bin).
 */
