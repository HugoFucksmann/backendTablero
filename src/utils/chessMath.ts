export const ChessMath = {
    cpToWhiteWinProb(cp: number, mate: number | null | undefined, isBlackTurn: boolean): number {
    ...
    cpToVisualScore(cp: number, mate: number | null | undefined, isBlackTurn: boolean): number {
        if (mate !== null && mate !== undefined) {
